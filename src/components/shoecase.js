...
class Shoecase extends React.Component {
  render() {
    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-4">
            <div className="single-special text-center wow fadeInRight" data-wow-offset={200} data-wow-duration=".8s" data-wow-delay=".2s">
              ...
              {/* <p>Engineering/Management disciplined trainers and auditors</p> */}
            </div>
          </div>
          {/* Single Special Area */}
          <div className="col-12 col-md-4">
            <div className="single-special text-center wow fadeInRight" data-wow-offset={200} data-wow-duration=".8s" data-wow-delay=".2s">
              ...
              <h4>Customizability</h4> */}
              <div className="list-jae">
              <li>Online Aerospace Supplier Information System (OASIS) registered Aerospace Experienced Auditors</li>
              </div>
              {/* <p>Online Aerospace Supplier Information System (OASIS) registered Aerospace Experienced Auditors</p> */}
            </div>
          </div>
        </div>
      </div>
      ...
      //             <span className="iconbox-text">Continuous Improvement</span>
      //           </li>
      //           <li className="iconbox iconbox-style-2">
      //             <i className="iconbox-icon fa fa-check" />
      //             <span className="iconbox-text">Outstanding Services</span>
      //           </li>
      //           <li className="iconbox iconbox-style-2">
      //             <i className="iconbox-icon fa fa-check" />
      //             <span className="iconbox-text">Customer Satisfaction</span>
      //           </li>
      //         </ul>
      ...
      //         <h3 className="section-heading global_color_1 font-35 wow fadeInLeft" data-wow-offset={200} data-wow-duration=".8s" data-wow-delay=".2s">What We Do</h3>
      ...
      //               <i className="iconbox-icon fa fa-id-badge" />
      //               <span className="iconbox-text">ADQMS</span>
      //             </a>
      //             <div className="collapse show iconbox-item-text" id="collapse1" role="tabpanel" aria-expanded="false">
      //               <p>
      //                 Adaptive Quality Systems is a comprehensive service provider for business management and operational solutions.
      //               </p>
      //             </div>
      //           </li>
      //           <li className="iconbox wow fadeInLeft" data-wow-offset={200} data-wow-duration=".8s" data-wow-delay=".2s">
      ...
      //               <i className="iconbox-icon fa fa-handshake-o" />
      //               <span className="iconbox-text">Our Mission</span>
      //             </a>
      //             <div className="collapse iconbox-item-text" id="collapse2" role="tabpanel" aria-expanded="false">
      //               <p>
      //                 Our Mission is to work side-by-side with our clients to design and implement unique business solutions that meet industry standards, produce consistent results, are easy to use, and are self-sustainable. With our extensive technical background and comprehensive knowledge of technical business standards, we will help you strengthen your business by:
      //               </p>

      //               <ul className="v-list list-text-icon m-b-20 wow fadeInRight" data-wow-offset={200} data-wow-duration=".8s" data-wow-delay=".2s">
      //                 <li className="iconbox iconbox-style-2">
      //                   <i className="iconbox-icon fa fa-check" />
      //                   <span className="iconbox-text">Obtaining ASO9100/ISO9001 Certification</span>
      //                 </li>
      //                 <li className="iconbox iconbox-style-2">
      //                   <i className="iconbox-icon fa fa-check" />
      //                   <span className="iconbox-text">Maintaining ASO9100/ISO9001 Certification in an Effective Manner </span>
      //                 </li>
      //                 <li className="iconbox iconbox-style-2">
      //                   <i className="iconbox-icon fa fa-check" />
      //                   <span className="iconbox-text">Offering in-house designed ERP/MRP system that is tailored to AS9100C/ISO9001:2008</span>
      //                 </li>
      //                 <li className="iconbox iconbox-style-2">
      //                   <i className="iconbox-icon fa fa-check" />
      //                   <span className="iconbox-text">Providing marketing assistant with the use of internet media</span>
      //                 </li>
      //               </ul>
      //             </div>
      //           </li>
