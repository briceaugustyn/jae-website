        ...
        return (
            ...
            <section id="training" className="main-section center-align section_padding_100 bg-white">
              ...
              <h4>Customizability</h4> */}
                                                <div className="list-jae">
                                                    <li>Aviation, Space and Defense Industry targeted online training & continual development programs</li>
                                                </div>
...
{/* Single Team Container */}
              ...
              <div className="line-shape" />
                ...
                <i className="ti-ruler-pencil" aria-hidden="true" />
                                                ...
                                                {/* <h4>Powerful Design</h4> */}
                                                <div className="list-jae">
                                                    <li>AS9100 Internal auditor training</li>
                                                </div>
                                                {/* <p>Over 300 company visits in various products and services</p> */}
                                            </div>
                                        </div>
              ...
              <h4>Customizability</h4> */}
                                                <div className="list-jae">
                                                    <li>How to implement sustainable AS9100 System and its practices</li>
                                                </div>
                                                {/* <p>Business continuity and longevity with our clients</p> */}
                                            </div>
                                        </div>
 ...
 <div className="col-12 col-md-4">
              ...
              <h4>Customizability</h4> */}
                                                <div className="list-jae">
                                                    <li>Aerospace First Article Inspection Requirement AS9102B</li>
                                                </div>
                                                {/* <p>Business continuity and longevity with our clients</p> */}
                                            </div>
                                        </div>
              ...
              <h4>Customizability</h4> */}
                                                <div className="list-jae">
                                                    <li>Aerospace Contract Clauses ARP9009</li>
                                                </div>
                                                {/* <p>Business continuity and longevity with our clients</p> */}
                                            </div>
                                        </div>
