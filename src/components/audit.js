...
<div className="col-6 col-md-4">
      ...
      //                 <a href>
      //                   <h5 className="global_color_1 text-center">Audit 1</h5>
      //                 </a>
      //                 {/* Team Member Job */}
      ...
      //                 {/* Team Member Name and link to his page */}
      //                 <a href>
      //                   <h5 className="global_color_1 text-center">Audit 2</h5>
      //                 </a>
      //                 {/* Team Member Job */}
      //                 <h6 className="text-center">Content 2</h6>
      ...
      //                 {/* Team Member Name and link to his page */}
      //                 <a href="#">
      //                   <h5 className="global_color_1">Audit 3</h5>
      //                 </a>
      //                 {/* Team Member Job */}
      //                 <h6 className="text-center">Content3</h6>
      ...
      //                 {/* Team Member Name and link to his page */}
      //                 <a href>
      //                   <h5 className="global_color_1">Audit 4</h5>
      //                 </a>
      //                 {/* Team Member Job */}
      //                 <h6 className="text-center m-b-2">Content4</h6>
